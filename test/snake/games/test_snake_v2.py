...
from snake.games.snake_v2 import Snake
...
class TestSnakeGen(unittest.TestCase):
    ...
    def test_gen_obs_dimension(self):
        obs = self.env.reset()
        self.assertEqual((32, 42, 3), obs.shape, "Observation dimension is not as expected")
        self.assertEqual(True, obs.dtype == np.uint8, "Observation type is not as expected")
