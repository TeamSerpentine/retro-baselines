...
from snake.games.snake_gen import Snake
...
class TestSnakeGen(unittest.TestCase):
    ...
    def test_gen_obs_dimension(self):
        obs = self.env.reset()
        self.assertEqual((24,), obs.shape, "Observation dimension is not as expected")
        self.assertEqual(True, obs.dtype == np.int, "Observation type is not as expected")
